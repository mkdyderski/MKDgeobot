#' @title Plot the structure of mode of polinations
#' 
#'@description This function plots the structure of mode of polinations in flora. 
...
#'@export
wyk_pollen=function(co){
  chorie=sort(table(co$pollen))/length(co$pollen)
  ...
  (p+ggplot2:::scale_y_continuous(name="Share [%]")+ggplot2:::scale_x_discrete("Main polination vector")
